...
class BinanceLiquidityEngine(object):
    ...
    SYMBOLS_ORDER_SIZE: dict = {"btcusd": {"BUY": 0.01, "SELL": 100}, "btcusdt": {"BUY": 0.01, "SELL": 100}}
    ...
    async def attach(self, symbol_id: SymbolId):
        self._symbols.append(symbol_id)
        ...
        await self._client.subscribe(f"{symbol_id}@miniTicker")
